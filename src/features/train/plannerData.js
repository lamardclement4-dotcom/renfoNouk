...
export const SPORT_FIELDS = {
  demi:    { icon:'🏃', label:'Demi-fond', fields:[
    ...
    {k:'denivele',t:'num',lab:'Dénivelé+ (m)',ph:'40',dir:'up'},
    {k:'cadence',t:'num',lab:'Cadence (pas/min)',ph:'176',dir:'up'},
  ...
  fond:    { icon:'🏃', label:'Fond / marathon', fields:[
    ...
    {k:'cadence',t:'num',lab:'Cadence (pas/min)',ph:'172',dir:'up'},
  ...
  marche:  { icon:'🥾', label:'Marche / randonnée', fields:[
    {k:'distance',t:'num',lab:'Distance (km)',ph:'12',step:0.1,dir:'up'},
    {k:'duree',t:'text',lab:'Durée',ph:'3h20'},
    {k:'denivele',t:'num',lab:'Dénivelé+ (m)',ph:'450',dir:'up'},
    {k:'denivele_neg',t:'num',lab:'Dénivelé− (m)',ph:'450',dir:'up'},
    {k:'terrain',t:'select1',lab:'Terrain',opts:['Plat','Vallonné','Montagne']},
    {k:'sac',t:'num',lab:'Poids du sac (kg)',ph:'8',step:0.5},
    {k:'altitude_max',t:'num',lab:'Altitude max (m)',ph:'1850',dir:'up'},
  ...
  velo:    { icon:'🚴', label:'Vélo / cyclisme', fields:[
    ...
    {k:'vitesse_max',t:'num',lab:'Vitesse max (km/h)',ph:'58',step:0.1,dir:'up'},
  ...
  vtt:     { icon:'🚵', label:'VTT', fields:[
    {k:'distance',t:'num',lab:'Distance (km)',ph:'30',step:0.1,dir:'up'},
    {k:'temps',t:'time',lab:'Temps (hh:mm)',ph:'2:00',dir:'down'},
  ...
  orientation:{ icon:'🧭', label:"Course d'orientation", fields:[
    {k:'distance',t:'num',lab:'Distance (km)',ph:'8',step:0.1,dir:'up'},
    {k:'temps',t:'time',lab:'Temps (mm:ss)',ph:'55:00',dir:'down'},
    {k:'denivele',t:'num',lab:'Dénivelé+ (m)',ph:'200',dir:'up'},
    {k:'difficulte',t:'select1',lab:'Difficulté carte',opts:['Facile','Moyen','Difficile']},
    {k:'postes',t:'num',lab:'Nb de postes',ph:'14',dir:'up'},
    {k:'erreurs',t:'num',lab:'Erreurs de navigation',ph:'2',dir:'down'},
    {k:'terrain',t:'select1',lab:'Terrain',opts:['Forêt','Urbain','Montagne','Dune']},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'7'}
  ]},
  triathlon:{ icon:'🏆', label:'Triathlon', fields:[
    {k:'nage',t:'num',lab:'Natation (m)',ph:'1500',dir:'up'},
    {k:'velo',t:'num',lab:'Vélo (km)',ph:'40',step:0.1,dir:'up'},
    {k:'course',t:'num',lab:'Course (km)',ph:'10',step:0.1,dir:'up'},
    {k:'temps_total',t:'time',lab:'Temps total (hh:mm)',ph:'2:30',dir:'down'},
    {k:'format',t:'select1',lab:'Format',opts:['Découverte','Sprint','Olympique','Half','Ironman']},
    {k:'temps_nage',t:'time',lab:'Temps natation (mm:ss)',ph:'28:00',dir:'down'},
    {k:'temps_velo',t:'time',lab:'Temps vélo (hh:mm)',ph:'1:12',dir:'down'},
    {k:'temps_course',t:'time',lab:'Temps course (mm:ss)',ph:'44:00',dir:'down'},
    {k:'t1',t:'time',lab:'Transition T1 (mm:ss)',ph:'2:10',dir:'down'},
    {k:'t2',t:'time',lab:'Transition T2 (mm:ss)',ph:'1:30',dir:'down'},
  ...
  natation:{ icon:'🏊', label:'Natation', fields:[
    {k:'distance',t:'num',lab:'Distance totale (m)',ph:'2000',dir:'up'},
    {k:'temps',t:'time',lab:'Temps (mm:ss)',ph:'38:00',dir:'down'},
    {k:'longueurs',t:'num',lab:'Nb longueurs',ph:'40',dir:'up'},
    ...
    {k:'temps_100',t:'time',lab:'Meilleur 100 m (mm:ss)',ph:'1:32',dir:'down'},
  ...
  surf:    { icon:'🏄', label:'Surf / paddle', fields:[
    ...
    {k:'vagues',t:'num',lab:'Nb vagues prises',ph:'12',dir:'up'},
  ...
  voile:   { icon:'⛵', label:'Voile / planche', fields:[
    ...
    {k:'distance',t:'num',lab:'Distance parcourue (milles)',ph:'12',step:0.1,dir:'up'},
    {k:'chavirage',t:'bool',lab:'Chavirage / chute ?'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'6'}
  ]},
  plongee: { icon:'🤿', label:'Plongée / apnée', fields:[
    {k:'profondeur',t:'num',lab:'Profondeur max (m)',ph:'18',dir:'up'},
  ...
  football:{ icon:'⚽', label:'Football', fields:[
    ...
    {k:'distance',t:'num',lab:'Distance parcourue (km)',ph:'9',step:0.1,dir:'up'},
    {k:'sprints',t:'num',lab:'Nb de sprints',ph:'18',dir:'up'},
  ...
  basket:  { icon:'🏀', label:'Basket / hand / volley', fields:[
    ...
    {k:'passes_d',t:'num',lab:'Passes décisives',ph:'4',dir:'up'},
    {k:'rebonds',t:'num',lab:'Rebonds / blocs',ph:'6',dir:'up'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'7'}
  ]},
  ...
  raquette:{ icon:'🎾', label:'Tennis / padel / badminton', fields:[
    {k:'duree',t:'num',lab:'Durée (min)',ph:'60',dir:'up'},
    {k:'type',t:'select1',lab:'Type',opts:['Match','Entraînement']},
    {k:'sets',t:'num',lab:'Nb sets',ph:'3',dir:'up'},
  ...
  pingpong:{ icon:'🏓', label:'Tennis de table', fields:[
    {k:'duree',t:'num',lab:'Durée (min)',ph:'45',dir:'up'},
    {k:'type',t:'select1',lab:'Type',opts:['Match','Entraînement']},
    {k:'sets',t:'num',lab:'Nb sets',ph:'5',dir:'up'},
    {k:'resultat',t:'select1',lab:'Résultat',opts:['Victoire','Défaite','Non joué']},
    {k:'score',t:'text',lab:'Score',ph:'11-7 9-11 11-5'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'5'}
  ]},
  frisbee: { icon:'🥏', label:'Ultimate / frisbee', fields:[
    {k:'duree',t:'num',lab:'Durée jouée (min)',ph:'60',dir:'up'},
    {k:'type',t:'select1',lab:'Type',opts:['Match','Entraînement']},
    {k:'points',t:'num',lab:'Points marqués',ph:'3',dir:'up'},
    {k:'distance',t:'num',lab:'Distance parcourue (km)',ph:'6',step:0.1,dir:'up'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'7'}
  ]},
  combat:  { icon:'🥋', label:'Sports de combat', fields:[
    {k:'duree',t:'num',lab:'Durée (min)',ph:'90',dir:'up'},
    ...
    {k:'rounds',t:'num',lab:'Nb de rounds / combats',ph:'5',dir:'up'},
    {k:'partenaires',t:'num',lab:'Nb de partenaires',ph:'3',dir:'up'},
  ...
  escrime: { icon:'🤺', label:'Escrime', fields:[
    ...
    {k:'touches',t:'num',lab:'Touches (optionnel)',ph:'',dir:'up'},
    {k:'arme',t:'select1',lab:'Arme',opts:['Fleuret','Épée','Sabre']},
    {k:'assauts',t:'num',lab:'Nb d’assauts',ph:'8',dir:'up'},
    {k:'victoires',t:'num',lab:'Assauts gagnés',ph:'5',dir:'up'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'7'}
  ]},
  lancers: { icon:'🥏', label:'Lancers', fields:[
    {k:'nb_lancers',t:'num',lab:'Nb lancers',ph:'20',dir:'up'},
    {k:'meilleure_perf',t:'num',lab:'Meilleure perf. (m)',ph:'',step:0.01,dir:'up'},
    ...
    {k:'moyenne_perf',t:'num',lab:'Moyenne des essais (m)',ph:'',step:0.01,dir:'up'},
    {k:'essais_valides',t:'num',lab:'Essais valides',ph:'16',dir:'up'},
    {k:'vent',t:'text',lab:'Vent',ph:'+1,2 m/s'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'6'}
  ]},
  saut:    { icon:'🦘', label:'Sauts (longueur / hauteur)', fields:[
    {k:'nb_sauts',t:'num',lab:'Nb sauts',ph:'12',dir:'up'},
    {k:'meilleure_perf',t:'num',lab:'Meilleure perf. (m)',ph:'',step:0.01,dir:'up'},
    {k:'type',t:'select1',lab:'Type',opts:['Longueur','Hauteur','Triple saut']},
    {k:'elan',t:'num',lab:'Longueur d’élan (foulées)',ph:'16'},
    {k:'essais_valides',t:'num',lab:'Essais valides',ph:'9',dir:'up'},
    {k:'vent',t:'text',lab:'Vent',ph:'+0,8 m/s'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'7'}
  ]},
  ski:     { icon:'⛷️', label:'Ski / snowboard', fields:[
    {k:'duree',t:'text',lab:'Durée sur les pistes',ph:'3h30'},
    {k:'descentes',t:'num',lab:'Nb descentes',ph:'8',dir:'up'},
    {k:'denivele',t:'num',lab:'Dénivelé cumulé (m)',ph:'2400',dir:'up'},
    ...
    {k:'vitesse_max',t:'num',lab:'Vitesse max (km/h)',ph:'72',step:0.1,dir:'up'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'6'}
  ]},
  ...
  trampoline:{ icon:'🤸', label:'Trampoline / acrobatie', fields:[
    ...
    {k:'series',t:'num',lab:'Nb de séries',ph:'10',dir:'up'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'6'}
  ]},
  golf:    { icon:'⛳', label:'Golf', fields:[
    {k:'trous',t:'num',lab:'Nb trous',ph:'18',dir:'up'},
    {k:'type',t:'select1',lab:'Type',opts:['Practice','Parcours']},
    {k:'score',t:'num',lab:'Score total',ph:'92',dir:'down'},
    {k:'putts',t:'num',lab:'Nb de putts',ph:'34',dir:'down'},
    {k:'fairways',t:'num',lab:'Fairways touchés',ph:'8',dir:'up'},
    {k:'marche',t:'bool',lab:'Parcours à pied ?'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'4'}
  ]},
  tir:     { icon:'🎯', label:"Tir à l'arc / tir", fields:[
    {k:'nb_tirs',t:'num',lab:'Nb tirs',ph:'30',dir:'up'},
    {k:'type',t:'select1',lab:'Type',opts:['Arc','Tir sportif']},
    {k:'distance',t:'num',lab:'Distance (m)',ph:'18',dir:'up'},
    {k:'score',t:'num',lab:'Score total',ph:'268',dir:'up'},
    {k:'volees',t:'num',lab:'Nb de volées',ph:'10',dir:'up'},
  ...
  petanque:{ icon:'🎯', label:'Pétanque / bowling', fields:[
    {k:'duree',t:'text',lab:'Durée',ph:'1h30'},
    {k:'parties',t:'num',lab:'Nb parties',ph:'3',dir:'up'},
    {k:'type',t:'select1',lab:'Type',opts:['Pétanque','Bowling']},
    {k:'gagnees',t:'num',lab:'Parties gagnées',ph:'2',dir:'up'},
    {k:'score',t:'num',lab:'Meilleur score',ph:'13',dir:'up'},
  ...
  equitation:{ icon:'🐴', label:'Équitation', fields:[
    ...
    {k:'obstacles',t:'num',lab:'Hauteur des obstacles (cm)',ph:'90',dir:'up'},
  ...
  gym:     { icon:'🤸', label:'Gymnastique', fields:[
    ...
    {k:'series',t:'num',lab:'Nb de passages',ph:'8',dir:'up'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'7'}
  ]},
  callisthenie:{ icon:'🤸', label:'Callisthénie / street workout', fields:[
    ...
    {k:'lest',t:'num',lab:'Lest utilisé (kg)',ph:'10',step:0.5,dir:'up'},
    {k:'rpe',t:'num',lab:'Intensité ressentie (RPE 1-10)',ph:'8'}
  ]},
  halterophilie:{ icon:'🏋️', label:'Haltérophilie', fields:[
    ...
    {k:'charge_max',t:'num',lab:'Charge max (kg)',ph:'80',dir:'up'},
    {k:'total',t:'num',lab:'Total arraché + épaulé-jeté (kg)',ph:'180',dir:'up'},
